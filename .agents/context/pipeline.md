...
1. **GLIMS selection** — `notebooks/pipeline/` notebooks read the GLIMS polygon shapefile, roll `geog_area`
...
3. **Metadata relationalization** — `notebooks/pipeline/07_metadata_time_series.ipynb`
...
7. **Inference** — `glacierview infer` (single glacier, GIF + area plot) or
